		...
		<div className="header-content ">
			<div className="wrapper flex justify-center">
				<div className="header-logo flex items-center">
					...
					<Link href="/">
						<div  className="mx-2 h-12 border-l-2 w-2"></div>
					</Link>
				</div>
				<div className="">
					<div className="text-3xl font-medium inline-block mr-2">Shopee Supermarket</div>
					<button className="bg-white px-2 rounded-full text-blue-500 text-sm inline-block">Ikuti</button>
				</div>
				<div>
					<form>
