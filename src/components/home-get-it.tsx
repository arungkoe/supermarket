...
export default function HomeGetIt() {
  return (
	<>
		...
		<div className="w-full relative z-20 container container-section">
			<div className="wrapper relative w-full">
				...
				<ul className="relative w-full px-6 overflow-auto flex lg:flex-row space-x-6">
					<li className="container relative w-40 mx-auto flex justify-center flex-col bg-rose-200 p-4">
					...
					<li className="container relative w-40 mx-auto flex justify-center flex-col">
					...
					<li className="container relative w-40 mx-auto flex justify-center flex-col bg-rose-200">
					...
					<li className="container relative w-60 mx-auto bg-rose-200 p-4">
